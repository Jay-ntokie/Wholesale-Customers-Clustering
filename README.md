...
Data Science assignment exploring unsupervised learning using K-Means clustering and Principal Component Analysis (PCA) on the Wholesale Customers dataset.
